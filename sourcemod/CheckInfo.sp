/* ==================================================================================================
  ...
  1.2.1 - HOTFIX 
	...
	1.4 - Теперь SteamWorks необязателен, но рекомендуется для возможности получения Prime-статуса
		- Изменил метод получения идентификатора BHOP из магазина. Теперь он обновляется каждую минуту
		- Теперь идентификатор BHOP для VIP указывается не в исходнике, а в ConVar (sm_checkinfo_vipbhop)
